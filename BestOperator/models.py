...
class DescriptionModel(models.Model):#TODO set cascade relations for models where needed
...
class NameDescrAutoGeneratedModel(DescriptionModel):
    ...
    def save(self, *args, **kwargs):
        if self.name == '<auto-generated>' and self.get_name():
...
class TermOfUsage(NameDescrAutoGeneratedModel):
    ...
    class Meta:
        ...
        ordering = ('service_type__name', 'criterion__name', 'amount', )
